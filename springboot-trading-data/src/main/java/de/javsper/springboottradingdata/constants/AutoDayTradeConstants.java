package de.javsper.springboottradingdata.constants;
...
public class AutoDayTradeConstants {
    ...
    public static final int SPX_TODAY_TICKER_IDENTIFIER = 100000;
    public static final int EXPECTED_MAX_VALUE_OF_SPX = 10000;
