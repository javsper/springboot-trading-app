...
private final PropertiesConfig propertiesConfig;
    ...
    @Bean ConsumerFactory<String, IBKRDataTypeEntity> entityConsumerFactory(){
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "de.javsper.springboottradingdata.model.entity.IBKRDataTypeEntity");
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "de.javsper.springboottradingdata.model.*");
